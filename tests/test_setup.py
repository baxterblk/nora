...
from nora.core.setup import (check_ollama_connection, first_run_wizard,
                             get_available_models, should_run_wizard)
...
class TestSetupWizard:
    ...
    def test_check_ollama_connection_success(self, mock_get):
        ...
        mock_get.assert_called_once_with(
            "http://localhost:11434/api/version", timeout=5, verify=False
        )
    ...
    def test_get_available_models_success(self, mock_get):
        ...
        mock_response.json.return_value = {
            "models": [{"name": "llama3:8b"}, {"name": "deepseek-coder:6.7b"}]
        }
        mock_response.raise_for_status = Mock()
        mock_get.return_value = mock_response
    ...
    @patch("builtins.input")
    @patch("builtins.print")
    def test_wizard_with_custom_values(
        self,
        mock_print,
        mock_input,
        mock_get_models,
    ...
    @patch("builtins.input")
    @patch("builtins.print")
    def test_wizard_connection_retry(
        self,
        mock_print,
        mock_input,
        mock_get_models,
    ...
    @patch("builtins.input")
    @patch("builtins.print")
    def test_wizard_no_models_available(
        self,
        mock_print,
        mock_input,
        mock_get_models,
